...
class AnalyticsViewModel extends ChangeNotifier {
  ...
  Map<String, double> get payeeTotals => Map.unmodifiable(_payeeTotals);
  ...
  List<AnalyticsCategory> get categories {
    ...
    // If no spend yet, show defaults from category list with zeroes
    if (items.isEmpty && _categories.isNotEmpty) {
